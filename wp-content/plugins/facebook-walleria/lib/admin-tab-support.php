				<h2><?php _e('Support', 'facebook-walleria'); ?></h2>

				<h3>Help with Fancybox</h3>
				<ul style="list-style-type:disc;padding-left:15px;">
					<li><?php _e('If you have problems or questions about FancyBox itself (and not this WordPress plugin), please start with these links: <a target="_blank" href="http://fancybox.net/howto">How-To</a> & <a target="_blank" href="http://fancybox.net/faq">FAQ</a>.<br />If that does not help, go to <a href="http://groups.google.com/group/fancybox">the FancyBox Google Group</a>, use the <strong>Search</strong> option, and if necesary, post your question.', 'facebook-walleria'); ?></li>
				</ul>
				
				<h3>Help with Facebook Walleria plugin</h3>
				<ul style="list-style-type:disc;padding-left:15px;">
					<li><?php _e('If you are having trouble with this plugin try to localize the problem (switch your theme and deactivate plugins until you find the source of the problem). ', 'facebook-walleria'); ?></li>
					<!--<li><?php _e('Try reverting these settings to their defaults with the button below.', 'facebook-walleria'); ?></li>-->
					<li><?php _e('If you still can not get the plugin to work, post a comment on <a href="http://zoxion.com/facebook-walleria/"> my blog </a>', 'facebook-walleria'); ?></li>
				</ul>
